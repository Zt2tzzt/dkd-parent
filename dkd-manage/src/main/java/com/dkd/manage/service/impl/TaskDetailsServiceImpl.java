...
public class TaskDetailsServiceImpl implements ITaskDetailsService {
    ...
    @Autowired
    public TaskDetailsServiceImpl(TaskDetailsMapper taskDetailsMapper) {
     ...
     * 批量新增工单详情
     *
     * @param taskDetails 工单详情列表
     * @return int
     */
    @Override
    public int inserTaskDetailsBatch(List<TaskDetails> taskDetails) {

...
--
-- Table structure for table `vendout_running`
--

DROP TABLE IF EXISTS `vendout_running`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vendout_running` (
...
CREATE TABLE `sku` (
  ...
  PRIMARY KEY (`sku_id`),
  UNIQUE KEY `sku_sku_name_uindex` (`sku_name`),
  KEY `sku_sku_class_ClassId_fk` (`class_id`),
  CONSTRAINT `sku_ibfk_1` FOREIGN KEY (`class_id`) REFERENCES `sku_class` (`class_id`)
...
CREATE TABLE `vending_machine` (
  ...
  CONSTRAINT `vending_machine_ibfk_1` FOREIGN KEY (`vm_type_id`) REFERENCES `vm_type` (`id`),
  CONSTRAINT `vending_machine_ibfk_2` FOREIGN KEY (`node_id`) REFERENCES `node` (`id`),
  CONSTRAINT `vending_machine_ibfk_3` FOREIGN KEY (`policy_id`) REFERENCES `policy` (`policy_id`)
...
--
-- Dumping data for table `task_collect`
--

LOCK TABLES `task_collect` WRITE;
/*!40000 ALTER TABLE `task_collect` DISABLE KEYS */;
INSERT INTO `task_collect` VALUES (89,NULL,0,0,0,NULL);
/*!40000 ALTER TABLE `task_collect` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `channel` (
  ...
  KEY `channel_inner_code_index` (`inner_code`),
  CONSTRAINT `channel_ibfk_1` FOREIGN KEY (`vm_id`) REFERENCES `vending_machine` (`id`)
...
CREATE TABLE `order_month_collect` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `order_month_collect_id_uindex` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='按月统计各公司销售情况表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `order_month_collect`
--

LOCK TABLES `order_month_collect` WRITE;
/*!40000 ALTER TABLE `order_month_collect` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_month_collect` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `policy` (
  ...
  UNIQUE KEY `policy_policy_name_uindex` (`policy_name`)
...
INSERT INTO `policy` VALUES (1,'九折优惠',90,'2020-09-14 02:51:05','2021-02-01 08:25:06'),(2,'八折优惠',80,'2020-12-18 06:10:39','2020-12-18 06:10:39'),(5,'冬季折扣',70,'2021-01-11 07:29:32','2024-05-13 14:15:32'),(9,'清爽夏日',50,'2021-02-01 08:23:10','2024-05-13 14:15:51');
...
CREATE TABLE `task_details` (
  ...
  CONSTRAINT `taskdetails_task_TaskId_fk` FOREIGN KEY (`task_id`) REFERENCES `task` (`task_id`)
...
INSERT INTO `task_details` VALUES (3750,526,'1-1',8,1,'可口可乐','https://likede2-java.itheima.net/image/product1.png'),(3751,526,'1-2',9,1,'可口可乐','https://likede2-java.itheima.net/image/product1.png'),(3752,526,'1-3',1,2,'小康师傅','https://likede2-java.itheima.net/image/product2.png'),(3753,526,'1-5',6,3,'统一奶茶','https://likede2-java.itheima.net/image/product3.png'),(3754,526,'3-1',1,7,'一百橙汁','https://likede2-java.itheima.net/image/product7.png'),(3755,526,'3-6',10,1,'可口可乐','https://likede2-java.itheima.net/image/product1.png'),(3768,542,'1-1',5,1,'可口可乐','https://likede2-java.itheima.net/image/product1.png'),(3769,542,'1-2',5,2,'康师傅','https://likede2-java.itheima.net/image/product2.png');
...
INSERT INTO `job` VALUES (1,80);
/*!40000 ALTER TABLE `job` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vm_type`
--
...
CREATE TABLE `task` (
  ...
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`task_id`),
  UNIQUE KEY `task_task_code_uindex` (`task_code`),
...
CREATE TABLE `sku_class` (
  ...
  UNIQUE KEY `sku_class_class_name_uindex` (`class_name`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品类型表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sku_class`
--

LOCK TABLES `sku_class` WRITE;
/*!40000 ALTER TABLE `sku_class` DISABLE KEYS */;
INSERT INTO `sku_class` VALUES (1,'饮料',0),(2,'零食',0),(3,'食品',0),(4,'玩具',0),(14,'化妆品',0);
/*!40000 ALTER TABLE `sku_class` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `role` VALUES (1,'1001','工单管理员'),(2,'1002','运营员'),(3,'1003','维修员');
...
INSERT INTO `task_type` VALUES (1,'投放工单',1),(2,'补货工单',2),(3,'维修工单',1),(4,'撤机工单',1);
...
CREATE TABLE `emp` (
  ...
  CONSTRAINT `emp_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`),
  CONSTRAINT `emp_ibfk_2` FOREIGN KEY (`region_id`) REFERENCES `region` (`id`)
...
INSERT INTO `emp` VALUES (2,'刘备',2,'北京市海淀区',2,'1002','运营员','13800000001','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:04'),(3,'关羽',2,'北京市海淀区',2,'1002','运营员','13800000002','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:06'),(4,'张飞',2,'北京市海淀区',3,'1003','维修员','13800000003','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:08'),(5,'赵云',2,'北京市海淀区',3,'1003','维修员','13800000004','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:10'),(6,'曹操',1,'北京市朝阳区',2,'1002','运营员','13900139001','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:11'),(7,'夏侯惇',1,'北京市朝阳区',2,'1002','运营员','13900000002','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:13'),(8,'许褚',1,'北京市朝阳区',3,'1003','维修员','13900139003','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:15'),(9,'张辽',1,'北京市朝阳区',3,'1003','维修员','13900000004','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:17'),(10,'孙权',3,'北京市西城区',2,'1002','运营员','13700000001','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:19'),(11,'周瑜',3,'北京市西城区',2,'1002','运营员','13700000002','http://likede2-java.itheima.net/image/avatar.png',0,'2024-06-10 07:06:58','2024-06-10 08:11:21'),(12,'吕蒙',3,'北京市西城区',3,'1003','维修员','13700000003','http://likede2-java.itheima.net/image/avatar.png',0,'2024-06-10 07:06:58','2024-06-10 08:11:24'),(13,'陆逊',3,'北京市西城区',3,'1003','维修员','13700000005','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:26'),(50,'孙一百',1,'北京市朝阳区',3,'1003','维修员','13700137009','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:28'),(51,'马超',2,'北京市海淀区',3,'1003','维修员','13900002222','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:30'),(52,'黄忠',2,'北京市海淀区',2,'1002','运营员','13900005555','http://likede2-java.itheima.net/image/avatar.png',1,'2024-06-10 07:06:58','2024-06-10 08:11:31'),(53,'测试员工',1,'北京市朝阳区',1,'1001','工单管理员','15100000001','/profile/upload/2024/05/18/4e7f3a15429bfda99bce42a18cdd1jpeg_20240518103539A002.jpeg',1,'2024-06-10 07:06:58','2024-06-10 08:11:33');

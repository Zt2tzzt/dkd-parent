...
4. **消费者**：扫描售货机上的二维码，可以打开此端。主要作用是完成在售货机的购物操作。
...
AI 即人工智能，是计算机科学体系下的一个学科，是指通过计算机系统，模拟人类智力的一种技术。
...
在与 AI 交流时，同一个问题使用不同的 Prompt 可能会获得不同的答案；为了调教出一个聪明的 AI 助手，就需要用到提示工程。
